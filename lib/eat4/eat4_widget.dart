...
import 'eat4_model.dart';
export 'eat4_model.dart';

class Eat4Widget extends StatefulWidget {
  const Eat4Widget({Key? key}) : super(key: key);

  @override
  _Eat4WidgetState createState() => _Eat4WidgetState();
}

class _Eat4WidgetState extends State<Eat4Widget> {
  late Eat4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Eat4Model());
  }
